...
<style scoped>
.layout { height: 100vh; display: flex; background: var(--bg-primary); }
...
:deep(.el-menu-item.is-active) {
  background: rgba(106, 95, 193, 0.25) !important;
...
.user-avatar {
  ...
  border-radius: 50%;
  background: var(--purple-sentry);
  color: #fff;
  display: flex; align-items: center; justify-content: center;
  font-size: 13px; font-weight: 600; flex-shrink: 0;
}
.user-detail { flex: 1; min-width: 0; }
.user-name { font-size: 12px; color: rgba(255,255,255,0.85); white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
.user-role { font-size: 10px; color: rgba(255,255,255,0.35); }
.logout-btn { color: rgba(255,255,255,0.35); font-size: 15px; padding: 4px; }
...
.page-title { font-size: 16px; font-weight: 600; color: var(--text-primary); letter-spacing: 0.3px; }
